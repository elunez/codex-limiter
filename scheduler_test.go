...
func TestSchedulerUsesLowerPriorityAccountWhenHigherPriorityIsFull(t *testing.T) {
	...
	service.overrides["auth-high"] = AccountOverride{Settings: accountSettingsFromGlobal(service.settings)}
	service.overrides["auth-free"] = AccountOverride{Settings: accountSettingsFromGlobal(service.settings)}
